...
if(inputaccess && inputaccess == password){document.body.innerHTML =  '<h3 style="font-size: 45px;">' + 'Thành công! bạn sẽ được chuyển hướng đến trang! Chúc bạn trải nghiệm vui vẻ' + '</h3>';window.location.replace('https://affiliate-cuong.blogspot.com/?access=' + passwordfinal)};
